...
public class ParameterizedTests {
    ...
    // 하나의 기능을 테스트 돌리기 위해 Parameterized 사용
    ...
    @ParameterizedTest
    @EnumSource(Month.class) // Enum 타입에 있는 모든 상수 필드에 대한 태스트
...
//    @CsvSource({"test,TEST", "tEst,TEST", "JavaScript, JAVASCRIPT"})
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/parameter-test-data.csv", numLinesToSkip = 1) // Key-value 로 구성된 파일
